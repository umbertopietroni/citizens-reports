...
__doc__ = """
modulo per parsing dei file html scaricati dalle varie sorgenti
e presenti nella directory sources 

ogniblocco di file e' contenuto nella sottodirectory

sources/<cityname>

dove <cityname> deve essere una delle chiavi del dizionario
rex_dict dove sono contenute le espressioni regolari 
per estrarre le informazioni cercate


dopo il parsing salva il risultato nel file dataset.csv
e le categorie nel file categories.dict
"""
